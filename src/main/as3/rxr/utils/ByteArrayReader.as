...
public class ByteArrayReader extends ByteArray {
    ...
    public static function stringToBytes(string:String):ByteArray {
    ...
    public function readUntilChar(character:String):String {
        var ba:ByteArray = readUntilByte(character.charCodeAt());
        ba.position = 0;
    ...
    public function splitByte(byte:int):Array {
        ...
        if (bytesAvailable > 0) {
            items.push(readFor(bytesAvailable));
        }

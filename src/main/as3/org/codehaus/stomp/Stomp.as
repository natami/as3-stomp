...
public class Stomp extends EventDispatcher {
    ...
    private static const SEND_COMMAND:String = "SEND";
    private static const BEGIN_COMMAND:String = "BEGIN";
    private static const COMMIT_COMMAND:String = "COMMIT";
    private static const ACK_COMMAND:String = "ACK";
    private static const ABORT_COMMAND:String = "ABORT";
    private static const UNSUBSCRIBE_COMMAND:String = "UNSUBSCRIBE";
    private static const DISCONNECT_COMMAND:String = "DISCONNECT";
    ...
    public function sendTextMessage(destination:String, message:String, headers:SendHeaders = null):void {
        ...
        transmit(SEND_COMMAND, h, messageBytes);
    }
    ...
    public function unsubscribe(destination:String, headers:UnsubscribeHeaders = null):void {
        ...
        h['destination'] = destination;
        transmit(UNSUBSCRIBE_COMMAND, h);
    }

    public function disconnect():void {
        transmit(DISCONNECT_COMMAND, {});
    }
    ...
    private function transmit(command:String, headers:Object, body:ByteArray = null):void {
        ...
        if (body) {
            transmission.writeBytes(body, 0, body.length);
        }
